...
extern OS_EVENT *RMailbox;
extern OS_EVENT *GMailbox;
extern OS_EVENT *BMailbox;
...
// modify for RGB
extern OS_EVENT *SDWriteQueueR;
extern OS_EVENT *SDWriteQueueG;
extern OS_EVENT *SDWriteQueueB;
