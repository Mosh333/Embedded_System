...
void handle_PS2_interrupts(PS2_buffer_struct *PS2_buffer_data) {
	...
	if(make_code_flag && PS2_buffer_data->fresh_Press_Flag)PS2_buffer_data->fresh_Press_Flag=0;

	if(!make_code_flag && !PS2_buffer_data->fresh_Press_Flag)PS2_buffer_data->fresh_Press_Flag=1;

		if (PS2_code == 0x58 && PS2_buffer_data->capital_Flag == 0 && PS2_buffer_data->fresh_Press_Flag) {PS2_buffer_data->capital_Flag = 1;}
		else if (PS2_code == 0x58 && PS2_buffer_data->capital_Flag == 1 && PS2_buffer_data->fresh_Press_Flag) {PS2_buffer_data->capital_Flag = 0;}
