...
int main() {
	...
	alt_u32 freq_0_buf = 0;
	alt_u32 freq_1_buf = 0;
	alt_u32 freq_2_buf = 0;
	alt_u32 freq_3_buf = 0;
	alt_u32 freq_4_buf = 0;
	alt_u32 freq_5_buf = 0;
	alt_u32 freq_6_buf = 0;
	alt_u32 freq_7_buf = 0;
